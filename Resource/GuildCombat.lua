...
AUTO_OPEN_IDC
{
	7	20	00   // 요일	시(24시간형식으로 입력)	      분
	6	20	00   // 요일	시(24시간형식으로 입력)	      분
	5	20	00   // 요일	시(24시간형식으로 입력)	      분
	4	20	00   // 요일	시(24시간형식으로 입력)	      분
	3	20	00   // 요일	시(24시간형식으로 입력)	      분
	2	20	00   // 요일	시(24시간형식으로 입력)	      분
	1	20	00   // 요일	시(24시간형식으로 입력)	      분
}

AUTO_OPEN_TEST
{
	1	19	00   // 요일	시(24시간형식으로 입력)	      분
	2	19	00   // 요일	시(24시간형식으로 입력)	      분
	3	19	00   // 요일	시(24시간형식으로 입력)	      분
	4	19	00   // 요일	시(24시간형식으로 입력)	      분
	5	19	00   // 요일	시(24시간형식으로 입력)	      분
	6	19	00   // 요일	시(24시간형식으로 입력)	      분
	7	19	00   // 요일	시(24시간형식으로 입력)	      분
}
...
//	WARSTATE	0		107	0 	// WAR_TELEPORT_STATE
	...
	WORLDMSG	5000		2706	101 	// TID_GAME_GUILDCOMBAT_OPEN_READY_MSG	
	WARSTATE	600000		101	102 	// NOTENTER_COUNT_STATE	
	WARSTATE	0		102	0 	// ENTER_STATE
