...
void CWndInventory::OnInitialUpdate()
{
	...
	CWndStatic* pGoldNum = (CWndStatic*) GetDlgItem( WIDC_GOLD_NUM );
	pGoldNum->m_dwColor = D3DCOLOR_ARGB( 255, 246, 204, 77 );
...
/***********************************************************************************
                                  ADEILSON V19
/***********************************************************************************/
	dwColor = D3DCOLOR_ARGB( 255, 246, 204, 77 );//AGORA
...
/***********************************************************************************/
	...
	*/
	...
	p2DRender->TextOut( 60, 113, prj.GetText((TID_APP_CHARACTER_DETAIL)), D3DCOLOR_ARGB( 255, 246, 204, 77 ));
	/////////////////////////// detail begin //////////////////////////////////
	int nyAdd = 121;
	int x = 5, nNextX = 100;
/***********************************************************************************
...
/***********************************************************************************/
			...
			DWORD dwColorName = D3DCOLOR_ARGB( 255, 246, 204, 77 );//agora
...
/***********************************************************************************
                                  ADEILSON V19
/***********************************************************************************/
	pWndStaticVagrant->m_dwColor = D3DCOLOR_ARGB( 255, 246, 204, 77 );
	pWndStatic1stJob->m_dwColor = D3DCOLOR_ARGB( 255, 246, 204, 77 );
	pWndStatic2ndJob->m_dwColor = D3DCOLOR_ARGB( 255, 246, 204, 77 );
	pWndStatic3rdJob->m_dwColor = D3DCOLOR_ARGB( 255, 246, 204, 77 );
/***********************************************************************************/
		...
		for( int x = 0; x < pWorld->m_nLandWidth; x++ )
		{
			...
			if( pLand )
			{
				...
				if( clipRect.RectLapRect( rectCur ) )
				{
					...
					{
						pLand->m_texMiniMap.m_size = m_size;
						pLand->m_texMiniMap.Render( p2DRender, point, 50 );//CWndBase::m_nAlpha );
...
void CWndQuestItemInfo::OnDraw(C2DRender* p2DRender)
{
	...
	p2DRender->TextOut(rectCtrl.left + 34, rectCtrl.top + 16 - 5, 1, 1, m_pItemBase->GetProp()->szName, 0xFF85FF8A);
...
#if __VER >= 19
	m_texGauEmptyNormal.LoadTexture( m_pApp->m_pd3dDevice, MakePath( DIR_THEME, "WndBar02.tga" ), 0xffff00ff, TRUE );
	m_texGauEmptySmall.LoadTexture( m_pApp->m_pd3dDevice, MakePath( DIR_THEME, "WndBar02.tga" ), 0xffff00ff, TRUE );
	m_texGauFillNormal.LoadTexture( m_pApp->m_pd3dDevice, MakePath( DIR_THEME, "WndBar02.tga" ), 0xffff00ff, TRUE );
	m_texGauFillSmall.LoadTexture( m_pApp->m_pd3dDevice, MakePath( DIR_THEME, "WndBar02.tga" ), 0xffff00ff, TRUE );
#else
	m_texGauEmptyNormal.LoadTexture( m_pApp->m_pd3dDevice, MakePath( DIR_THEME, "GauEmptyNormal.bmp" ), 0xffff00ff, TRUE );
